...
<head>
    ...
    <title>Informes - La Pica del Pescador</title>
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.13.1/font/bootstrap-icons.min.css">
    <link rel="stylesheet" href="css/navbar.css">
    <style>
        .main-content { margin-top: 90px; position: relative; }
        .wave { position: fixed; left: 0; bottom: 0; width: 100vw; min-width: 100%; height: 180px; z-index: -2; pointer-events: none; }
    </style>
</head>
<body>
    <!-- Navbar superior -->
    ...
    <div class="container main-content">
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">Informe de ventas</div>
                    <div class="card-body">
                        <form id="form-ventas">
                            <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">Informe de empleados</div>
                    <div class="card-body">
                        <form id="form-empleados">
                            <div class="mb-3">
                                <label for="fechaInicioEmpleados" class="form-label">Fecha inicio</label>
                                <input type="date" class="form-control" id="fechaInicioEmpleados">
                            </div>
                            <div class="mb-3">
                                <label for="fechaFinEmpleados" class="form-label">Fecha fin</label>
                                <input type="date" class="form-control" id="fechaFinEmpleados">
                            </div>
                            <button type="submit" class="btn btn-success">Generar informe</button>
                        </form>
                    </div>
    ...
    <svg class="wave" viewBox="0 0 1440 180" preserveAspectRatio="none" style="height:180px;">
        <path fill="#4fc3f7" fill-opacity="0.6" d="M0,90 C360,180 1080,0 1440,90 L1440,180 L0,180 Z"></path>
        <path fill="#81d4fa" fill-opacity="0.5" d="M0,120 C400,20 1040,180 1440,120 L1440,180 L0,180 Z"></path>
        <path fill="#b3e0ff" fill-opacity="0.4" d="M0,180 C400,60 1040,180 1440,180 L1440,180 L0,180 Z"></path>
    </svg>
