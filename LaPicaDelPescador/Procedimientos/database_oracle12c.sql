...
CREATE TABLE Comanda 
    ( 
     ...
     CoHoraFinal         DATE , 
     DetallePedido_DePID INTEGER  NOT NULL 
    ) 
;
CREATE UNIQUE INDEX Comanda__IDX ON Comanda 
    ( 
     DetallePedido_DePID ASC 
    ) 
;
...
ALTER TABLE Comanda 
    ADD CONSTRAINT Comanda_DetallePedido_FK FOREIGN KEY 
    ( 
     DetallePedido_DePID
    ) 
...
ALTER TABLE DetalleSueldo 
    ADD CONSTRAINT DetalleSueldo_Trabajador_FK FOREIGN KEY 
    ( 
     Trabajador_TrID
    ) 
...
ALTER TABLE FechaDetalle 
    ADD CONSTRAINT FechaDetalle_Trabajador_FK FOREIGN KEY 
    ( 
     Trabajador_TrID
    ) 
    REFERENCES Trabajador 
...
ALTER TABLE Producto 
    ADD CONSTRAINT Producto_Local_FK FOREIGN KEY 
    ( 
     Local_LoID
    ) 
    REFERENCES Local 
...
CREATE OR REPLACE TRIGGER ARC_FKArc_2_Envasado 
...
CREATE OR REPLACE TRIGGER ARC_FKArc_2_Platillo_Preparado 
BEFORE INSERT OR UPDATE OF PrID 
